# aime_jeux 04-04-2015
#  HDMUYan - Converter for HDMU enigma2
...
class HDMUYan(Poll, Converter, object):
    IP = 0
    NETMASK = 1
    GATEWAY = 2
    MEMTOTAL = 3
    ...
    def __init__(self, type):
        ...
        self.type = {'ip': self.IP,
         'netmask': self.NETMASK,'gateway': self.GATEWAY,'memtotal': self.MEMTOTAL,'memfree': self.MEMFREE,'stb': self.STB,
